...
public class Main3Activity extends AppCompatActivity {
    ...
    TextView scheduleupdate, logout;
    Button showTime;
...
//        spinnerPlaces = (Spinner) findViewById (R.id.spinner_places);
        ...
        logout = findViewById(R.id.textViewSignup2);
...
//                final String scheduleup = appliances.getSchedule();
                ...
                showTime.setOnClickListener (new View.OnClickListener ( ) {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText (getApplicationContext (),"Schedule is updated to"+ scheduleupdate,Toast.LENGTH_SHORT).show ();
